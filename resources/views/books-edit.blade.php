...
@section('content')
    ...
    <div class="mt-5 w-50">
        ...
        <form action="/book-edit/{{ $books->slug }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mt-3">
                <label for="kode_book" class="form-label">Book Code</label>
                <input type="text" name="kode_book" id="kode_book" class="form-control" placeholder="Books Code"
                    value="{{ $books->kode_book }}">
            ...
            <div class="mb-3">
                <label for="currentImage" class="form-label">Image Saat ini</label>
                <div class="w-50">
                    @if ($books->cover != '')
            ...
            <div class="mt-3">
                <label for="categories">Category Saat ini</label>
                <ul>
